...
/// <summary>
/// 生成:2018/03/27 07:32:06
/// 
/// </summary>
@Getter
public class AngelRiskBModel implements IBinder
{
    public long row_id;
    public long open_id;
    ...
    public String risk_details_url;
	...
	public void bind(GetHandlerEx s)
	{
        ...
        risk_details_url = s.get("risk_details_url").value(null);
