...
//    }
    ...
    //保存app信息
    public static boolean editApp(Integer app_id, String name, Integer agroup_id, Integer ugroup_id, String app_key,String akey, Integer ar_is_examine,Integer ar_is_setting, String note, Integer ar_examine_ver) throws SQLException {
