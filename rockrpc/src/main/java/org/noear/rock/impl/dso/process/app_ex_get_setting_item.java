...
/// </summary>
public class app_ex_get_setting_item extends DbQueryProcedure
{
    public app_ex_get_setting_item(DbContext db)
    {
        super(db);
        ...
        lazyload(()->{
            ...
            if(agroup_id>0) {
                ...
                sql("SELECT * from appx_ex_setting WHERE app_id>0 AND app_id=@app_id AND name=@name;");
            }
        });
    }
