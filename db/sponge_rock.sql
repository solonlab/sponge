...
CREATE TABLE `appx_ex_code`  (
                                 ...
                                 `lang` varchar(40) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
...
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin COMMENT = 'dwd' ROW_FORMAT = Dynamic;
...
CREATE TABLE `appx_ex_i18n`  (
                                 ...
                                 `agroup_id` int(11) NOT NULL DEFAULT 0,
                                 `service` varchar(40) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL DEFAULT '' COMMENT '服务名',
                                 `name` varchar(40) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '0',
                                 `lang` varchar(40) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
                                 `note` varchar(2000) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL DEFAULT NULL,
                                 `log_fulltime` datetime NULL DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP,
                                 PRIMARY KEY (`row_id`) USING BTREE,
                                 UNIQUE INDEX `IX_key`(`agroup_id`, `service`, `name`, `lang`) USING BTREE,
                                 INDEX `IX_agroup_id`(`agroup_id`) USING BTREE,
                                 INDEX `IX_service`(`service`, `lang`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = 'dwd' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin COMMENT = '应用组设置表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `appx_ex_version`  (
                                    ...
                                    `content` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL DEFAULT NULL COMMENT '更新内容',
                                    ...
                                    `log_fulltime` datetime NULL DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP,
                                    PRIMARY KEY (`row_id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin COMMENT = 'app版本更新记录' ROW_FORMAT = Dynamic;
