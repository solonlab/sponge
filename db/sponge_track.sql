...
-- ----------------------------
-- Table structure for _tmp_total_pv_uv_ip
-- ----------------------------
DROP TABLE IF EXISTS `_tmp_total_pv_uv_ip`;
CREATE TABLE `_tmp_total_pv_uv_ip`  (
...
-- ----------------------------
-- Table structure for _tmp_track_total_pv_uv_ip
-- ----------------------------
DROP TABLE IF EXISTS `_tmp_track_total_pv_uv_ip`;
CREATE TABLE `_tmp_track_total_pv_uv_ip`  (
                                              `obj_id` bigint(20) NOT NULL,
                                              `vi` int(11) NOT NULL DEFAULT 0,
                                              `vd` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL DEFAULT '',
                                              `pv` bigint(20) NOT NULL DEFAULT 0,
                                              `uv` bigint(20) NOT NULL DEFAULT 0,
                                              `ip` bigint(20) NOT NULL DEFAULT 0,
                                              `uk` bigint(20) NOT NULL DEFAULT 0,
...
CREATE TABLE `code_city`  (
                              ...
                              `city_name` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL DEFAULT '',
...
INSERT INTO `code_enum` VALUES (2002, 2, 102, '微信', '%MicroMessenger/%');
...
-- ----------------------------
-- Table structure for code_ip
-- ----------------------------
DROP TABLE IF EXISTS `code_ip`;
CREATE TABLE `code_ip`  (
                            `ip_id` bigint(20) NOT NULL,
                            `ip_val` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL DEFAULT '',
...
-- ----------------------------
-- Table structure for code_ua
-- ----------------------------
DROP TABLE IF EXISTS `code_ua`;
CREATE TABLE `code_ua`  (
                            `ua_id` bigint(20) NOT NULL,
                            `ua_key` varchar(40) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL DEFAULT '',
                            `ua_val` varchar(999) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL DEFAULT NULL,
...
-- ----------------------------
-- Table structure for short_redirect_log_30d
-- ----------------------------
DROP TABLE IF EXISTS `short_redirect_log_30d`;
CREATE TABLE `short_redirect_log_30d`  (
                                           `log_id` bigint(20) NOT NULL,
                                           `url_id` bigint(20) NULL DEFAULT NULL,
                                           `tag_id` int(11) NULL DEFAULT NULL,
                                           `user_id` bigint(20) NOT NULL DEFAULT 0,
                                           `user_key` varchar(40) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL DEFAULT '',
                                           `v1` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL DEFAULT '',
                                           `v2` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL DEFAULT '',
                                           `v3` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL DEFAULT '',
                                           `v4` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL DEFAULT '',
                                           `v5` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL DEFAULT '',
                                           ...
                                           `referer_url` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL DEFAULT NULL,
...
CREATE TABLE `short_url`  (
                              ...
                              `url_partner_key` varchar(40) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL DEFAULT '' COMMENT '合作方的url_key（tag下唯一）',
                              `url_key` varchar(40) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL DEFAULT '',
                              `url_name` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL DEFAULT NULL,
                              `url_val_md5` varchar(40) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL DEFAULT '',
                              `url_val` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL DEFAULT NULL,
                              `user_field` varchar(40) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL DEFAULT '' COMMENT '用户主键字段的参数名',
                              `track_params` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL DEFAULT '' COMMENT '监听的参数（记入log表，最多支持5个）例：c,b,d',
                              `track_params_num` int(11) NOT NULL DEFAULT 0,
                              `trans_params` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL DEFAULT '' COMMENT '例：c=x,b=y',
                              `build_link` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL DEFAULT '' COMMENT '构建连接代码（例：网页::f=web）',
...
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin COMMENT = 'URL' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Table structure for short_url_ex_stat
-- ----------------------------
DROP TABLE IF EXISTS `short_url_ex_stat`;
CREATE TABLE `short_url_ex_stat`  (
                                      `url_id` bigint(20) NOT NULL COMMENT 'URL ID',
                                      `tag_id` int(11) NOT NULL DEFAULT 0 COMMENT '标签ID',
                                      `admin_group` int(11) NOT NULL DEFAULT 0 COMMENT '管理组（同一管理组可见）',
...
-- ----------------------------
-- Table structure for short_url_ex_track_stat
-- ----------------------------
DROP TABLE IF EXISTS `short_url_ex_track_stat`;
CREATE TABLE `short_url_ex_track_stat`  (
...
-- ----------------------------
-- Table structure for stat_city_date_pv_uv_ip
-- ----------------------------
DROP TABLE IF EXISTS `stat_city_date_pv_uv_ip`;
CREATE TABLE `stat_city_date_pv_uv_ip`  (
                                            `row_id` bigint(20) NOT NULL AUTO_INCREMENT,
...
-- ----------------------------
-- Table structure for stat_date_hour_pv_uv_ip
-- ----------------------------
DROP TABLE IF EXISTS `stat_date_hour_pv_uv_ip`;
CREATE TABLE `stat_date_hour_pv_uv_ip`  (
                                            `row_id` bigint(20) NOT NULL AUTO_INCREMENT,
                                            `url_id` bigint(20) NOT NULL DEFAULT 0,
                                            `tag_id` int(11) NOT NULL DEFAULT 0,
                                            `log_date` int(11) NOT NULL DEFAULT 0,
...
-- ----------------------------
-- Table structure for stat_track_date_hour_pv_uv_ip
-- ----------------------------
DROP TABLE IF EXISTS `stat_track_date_hour_pv_uv_ip`;
CREATE TABLE `stat_track_date_hour_pv_uv_ip`  (
                                                  `row_id` bigint(20) NOT NULL AUTO_INCREMENT,
                                                  `url_id` bigint(20) NOT NULL DEFAULT 0,
                                                  `tag_id` int(11) NOT NULL DEFAULT 0,
                                                  `vi` int(11) NOT NULL DEFAULT 0,
...
-- ----------------------------
-- Table structure for stat_ua_client_date_pv_uv_ip
-- ----------------------------
DROP TABLE IF EXISTS `stat_ua_client_date_pv_uv_ip`;
CREATE TABLE `stat_ua_client_date_pv_uv_ip`  (
                                                 `row_id` bigint(20) NOT NULL AUTO_INCREMENT,
                                                 `url_id` bigint(20) NOT NULL DEFAULT 0,
                                                 `tag_id` int(11) NOT NULL DEFAULT 0,
...
-- ----------------------------
-- Table structure for stat_ua_platform_date_pv_uv_ip
-- ----------------------------
DROP TABLE IF EXISTS `stat_ua_platform_date_pv_uv_ip`;
CREATE TABLE `stat_ua_platform_date_pv_uv_ip`  (
                                                   `row_id` bigint(20) NOT NULL AUTO_INCREMENT,
                                                   `url_id` bigint(20) NOT NULL DEFAULT 0,
                                                   `tag_id` int(11) NOT NULL DEFAULT 0,
...
-- ----------------------------
-- Table structure for track_tag
-- ----------------------------
DROP TABLE IF EXISTS `track_tag`;
CREATE TABLE `track_tag`  (
                              `tag_id` int(11) NOT NULL AUTO_INCREMENT COMMENT '标签ID',
                              `agroup_id` int(11) NOT NULL DEFAULT 0 COMMENT '标签父ID',
                              `tag_name` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL DEFAULT NULL COMMENT '标签名称',
                              `tag_access_key` varchar(40) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL DEFAULT '',
                              `t_user_field` varchar(40) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL DEFAULT '' COMMENT '用户主键字段的参数名（在新建短地址时显示）',
                              `t_track_params` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL DEFAULT '' COMMENT '监听的参数（最多5个.例：c,b,d）（在新建短地址时显示）',
                              `t_track_params_num` int(11) NOT NULL DEFAULT 0,
                              `t_trans_params` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL DEFAULT '' COMMENT '透传参数（例：c=x,b=y）（在新建短地址时显示）',
                              `t_build_link` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL DEFAULT '',
                              `note` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL DEFAULT NULL,
                              `admin_group` int(11) NOT NULL DEFAULT 0 COMMENT '管理组（同一管理组可见）',
                              `tag_host` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL DEFAULT NULL COMMENT '标签主机',
                              PRIMARY KEY (`tag_id`) USING BTREE
) ENGINE = InnoDB  CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin COMMENT = '标签' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Table structure for track_tag_ex_stat
-- ----------------------------
DROP TABLE IF EXISTS `track_tag_ex_stat`;
CREATE TABLE `track_tag_ex_stat`  (
                                      `tag_id` int(11) NOT NULL COMMENT '标签ID',
...
-- ----------------------------
-- Table structure for track_tag_ex_track_stat
-- ----------------------------
DROP TABLE IF EXISTS `track_tag_ex_track_stat`;
CREATE TABLE `track_tag_ex_track_stat`  (
                                            `row_id` bigint(20) NOT NULL AUTO_INCREMENT,
                                            `tag_id` int(11) NOT NULL COMMENT '标签ID',
                                            `tag_pid` int(11) NOT NULL DEFAULT 0 COMMENT '标签父ID',
                                            `admin_group` int(11) NOT NULL DEFAULT 0 COMMENT '管理组（同一管理组可见）',
